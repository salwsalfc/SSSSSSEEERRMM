...
@co_od.ar_cmd(pattern="وضع بايو ([\s\S]*)")
async def _(event):
...
@co_od.ar_cmd(pattern="وضع اسم ([\s\S]*)")
async def _(event):
...
@co_od.ar_cmd(pattern="وضع يوزر ([\s\S]*)")
...
@co_od.ar_cmd(pattern="ازالة الصورة ?([\s\S]*)")
