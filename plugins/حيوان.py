...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 ╼•✬•سورس واسط➪︎ @wasit_go  •✬•╾ "
    ...
    if x == 3:
       ...
       caption += f"<b> • 🌚 | نسبتـه  ⇦  {yoy} </b>\n\n\n"
       caption += f"<b> 𓆩 ╼•✬•سورس واسط➪︎ @wasit_go  •✬•╾ 𓆪  "
...
async def who(event):
    ...
    if replied_user.id in zel_dev:
       return await edit_or_reply(zed, "**✪ هاي. . انـهُ احـد المطـورين . . انتـه الحيـوان ولك**")
    if replied_user.id == 5656828413 or replied_user.id == 5680297831 or replied_user.id == 5680297831:
       return await edit_or_reply(zed, "**✪ هاي. . انـهُ المطـور . . انتـه الحيـوان ولك**")
