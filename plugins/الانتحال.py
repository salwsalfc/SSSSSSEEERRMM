...
from co_od.Config import Config
from co_od.sql_helper.globals import gvarstatus
from co_od.plugins import ALIVE_NAME, BOTLOG, BOTLOG_CHATID, co_od, edit_delete, get_user_from_event
...
@co_od.ar_cmd(pattern="انتحال(?:\s|$)([\s\S]*)")
async def _(event):
