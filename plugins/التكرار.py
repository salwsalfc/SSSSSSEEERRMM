...
@co_od.ar_cmd(pattern="تعبير انشر $")
...
@co_od.ar_cmd(pattern="ايقاف النشر ?(.*)")
async def stopspamrz(event):
    if gvarstatus("spamwork") is not None and gvarstatus("spamwork") == "true":
        delgvar("spamwork")
        return await edit_delete(event, "**⌔∮ تم بنجاح ايقاف النشر **")
