...
ROE = "** هـذه هي قائمة اوامـر سـورس واسط  **"
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("اوامري") and event.query.user_id == sbb_b.uid:
            buttons = [
                [Button.inline("معلومات واسط ", data="AOMRDB")],
                [
...
اوامر فارات سورس واسط  @wasit_go""",
        buttons=[
...
* يمكنك الحصول على  كليشة جاهزة من هذه القناة @wasit_go
ملاحظة : يمكنك استخدام الاوامر في اي دردشة او محادثة
اوامر فارات سورس واسط  @wasit_go""",
        buttons=[
            [Button.inline("رجوع", data="pmvars")],
