...
__author__ = "سورس واسط <https://github.com/sourcesemsem/PYROGRAM>"
__copyright__ = f" حقوق سورس واسط (C) 2020 - 2022  {__author__}"

sbb_b.version = __version__
sbb_b.tgbot.version = __version__
LOGS = logging.getLogger("سورس واسط ")
bot = sbb_b
tbot = tgbot
...
def close_connection(*_):
    print("تم اغلاق الاتصال بالسورس واسط ")
